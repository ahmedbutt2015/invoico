...
@section('body')
    <div class="row">
        <div class="app">
            ...
            <form id="invoice" enctype="multipart/form-data" method="post" class="card bg-white display--block m-t-md m-t-lg--tablet m-t-xl--desktop m-b-md m-b-lg--tablet" >
                {{csrf_field()}}
            ...
            <span>
                ...
                <select id="invoice__currency" name="currency" class="m-r-md">
                    ...
                    <div class="details__column flex__basis0 flex__grow flex flex--baseline invoice__submitContainer">
                        ...
                        <div class="flex__grow"></div>
                        <button  name="" value="draft"   class="button button--blue-inverted m-v-sm invoice_submit_button" type="submit" style="margin-right:10px;color:#5354CE">Save as Draft</button>
